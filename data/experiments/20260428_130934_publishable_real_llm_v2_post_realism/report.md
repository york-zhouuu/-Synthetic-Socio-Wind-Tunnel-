# publishable_real_llm_v2_post_realism — Rival Hypothesis Contest Report
...
- encounter density (per-day median): 1450.75 95% CI [1106.61, 1794.89]
...
- primary metric `trajectory_deviation_m`: 198.14 95% CI [160.35, 235.93]
- encounter (per-day median): 1151.25 95% CI [982.39, 1320.11]
...
- primary metric `trajectory_deviation_m`: 218.95 95% CI [193.64, 244.26]
- encounter (per-day median): 1298.25 95% CI [997.34, 1599.16]
- mirror delta vs `hyperlocal_push`: 20.81
- evidence alignment: **inconclusive**
- reviewer notes: inconclusive: CI overlap between variant and reference for trajectory_deviation_m [preliminary—seed count < 30]
- **⚠️ preliminary — seed count < 30**
...
- primary metric `encounter.per_day_median`: 1393.00 95% CI [1065.72, 1720.28]
- encounter (per-day median): 1393.00 95% CI [1065.72, 1720.28]
- evidence alignment: **inconclusive**
...
- encounter (per-day median): 1450.75 95% CI [1106.61, 1794.89]
- evidence alignment: **inconclusive**
...
- primary metric `encounter.per_day_median`: 1481.75 95% CI [1154.71, 1808.79]
- encounter (per-day median): 1481.75 95% CI [1154.71, 1808.79]
- evidence alignment: **inconclusive**
- reviewer notes: inconclusive: CI overlap between variant and reference for encounter.per_day_median [preliminary—seed count < 30]
- **⚠️ preliminary — seed count < 30**
...
|---|---|---|---|---|---|---|---|
| `baseline` | — | encounter.per_day_median | 1450.75 | 95% CI [1106.61, 1794.89] | 1450.75 | **inconclusive** | — |
| `hyperlocal_push` | H_info | trajectory_deviation_m | 198.14 | 95% CI [160.35, 235.93] | — | **inconclusive** | — |
| `global_distraction` | H_info | trajectory_deviation_m | 218.95 | 95% CI [193.64, 244.26] | — | **inconclusive** | 20.81 |
| `shared_anchor` | H_meaning | encounter.per_day_median | 1393.00 | 95% CI [1065.72, 1720.28] | 1450.75 | **inconclusive** | — |
| `phone_friction` | H_pull | attention.phone_feed_proxy | 0.00 | 95% CI [0.00, 0.00] | 0.00 | **inconclusive** | — |
| `catalyst_seeding` | H_structure | encounter.per_day_median | 1481.75 | 95% CI [1154.71, 1808.79] | 1450.75 | **inconclusive** | — |
...
|---|---|---|---|
| `baseline` | 1402.50 | 1416.00 | 1.01 |
| `hyperlocal_push` | 1054.00 | 1153.50 | 1.09 |
| `global_distraction` | 1168.50 | 1220.00 | 1.04 |
| `shared_anchor` | 1314.50 | 1299.00 | 0.99 |
| `phone_friction` | 1402.50 | 1416.00 | 1.01 |
| `catalyst_seeding` | 1501.00 | 1524.50 | 1.02 |
...
- `global_distraction` vs `hyperlocal_push`: mirror delta = +20.81
