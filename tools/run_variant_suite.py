...
def _setup_aitown_stack(
    *,
    ...
    try:
        ...
        # 2026-05-17 bug fix: removed `not rt.profile.identity_text` gate.
        # sample_population(generate_identity=True) earlier fills identity_text
        # with low-quality haiku-tier inline LLM output; the cache contains
        # sonnet-tier v2-prompt narratives generated by prewarm. Cache always
        # wins on HIT — otherwise the 13-hour prewarm of identity_text is
        # wasted and protag prompts use the inferior haiku version.
        identity_injected = 0
        for rt in runtimes:
