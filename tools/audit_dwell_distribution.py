...
# persist-per-day-summaries-across-resumes (2026-05-20): exclude
# seed_<N>_day<D>.summary.json, seed_<N>_tick<T>.snapshot.json,
# seed_<N>_positions.json, seed_<N>_day<D>.partial.json from
# canonical seed scans.
