# sensitivity_0.4 — Rival Hypothesis Contest Report
...
| LANE_COVE_PROFILE_hash | `01fcee4bd9094cf9...` |
...
- encounter density (per-day median): 5753.00 95% CI [5753.00, 5753.00]
...
- primary metric `encounter.per_day_median`: 5647.00 95% CI [5647.00, 5647.00]
- encounter (per-day median): 5647.00 95% CI [5647.00, 5647.00]
- evidence alignment: **not_consistent**
- reviewer notes: evidence not consistent with H_pull: primary metric trends opposite to expected direction [preliminary—seed count < 30]
...
- primary metric `trajectory_deviation_m`: 1605.33 95% CI [1605.33, 1605.33]
- encounter (per-day median): 5753.00 95% CI [5753.00, 5753.00]
...
<!-- auto-generated from contest.json; 3 rows -->

| variant | hypothesis | primary metric | effect size | 95% CI | baseline | alignment | mirror Δ |
|---|---|---|---|---|---|---|---|
| `baseline` | — | encounter.per_day_median | 5753.00 | 95% CI [5753.00, 5753.00] | 5753.00 | **inconclusive** | — |
| `phone_friction` | H_pull | encounter.per_day_median | 5647.00 | 95% CI [5647.00, 5647.00] | 5753.00 | **not_consistent** | — |
| `global_distraction` | H_info | trajectory_deviation_m | 1605.33 | 95% CI [1605.33, 1605.33] | — | **inconclusive** | — |
...
|---|---|---|---|
| `baseline` | 5844.00 | 5844.00 | 1.00 |
| `phone_friction` | 5647.00 | 5647.00 | 1.00 |
| `global_distraction` | 5844.00 | 5844.00 | 1.00 |
...
- `global_distraction` vs `hyperlocal_push`: mirror delta = +N/A
