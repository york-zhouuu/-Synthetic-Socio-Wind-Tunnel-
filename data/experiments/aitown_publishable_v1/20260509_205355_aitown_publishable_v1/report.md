# aitown_publishable_v1 — Rival Hypothesis Contest Report
...
| code_commit | `66794d725b52fc97...` |
| phase_config | `baseline_days=4, intervention_days=,, post_days=6` |


## Act 1 — Baseline

<!-- auto-generated from variant_baseline/aggregate.json; seeds=3 -->

**Diagnosis** (baseline scene): Lane Cove 社区原始状态下 14 天的活动。

**Outcome** (auto-filled):

- encounter density (per-day median): 1314.00 95% CI [935.90, 1673.10]
- seeds: 3 **[preliminary — below β rigor 30]**
...
<!-- auto-generated from variant_hyperlocal_push/aggregate.json; seeds=3 -->
...
- primary metric `trajectory_deviation_m`: 325.52 95% CI [212.81, 394.90]
- encounter (per-day median): 1287.50 95% CI [934.58, 1633.78]
...
<!-- auto-generated from variant_global_distraction/aggregate.json; seeds=3 -->
...
- primary metric `trajectory_deviation_m`: 325.52 95% CI [212.81, 426.83]
- encounter (per-day median): 1314.00 95% CI [935.90, 1673.10]
- mirror delta vs `hyperlocal_push`: 0.00
- evidence alignment: **inconclusive**
- reviewer notes: inconclusive: CI overlap between variant and reference for trajectory_deviation_m [preliminary—seed count < 30]
- **⚠️ preliminary — seed count < 30**
...
<!-- auto-generated from variant_phone_friction/aggregate.json; seeds=3 -->
...
|---|---|---|---|---|---|---|---|
| `baseline` | — | encounter.per_day_median | 1314.00 | 95% CI [935.90, 1673.10] | 1314.00 | **inconclusive** | — |
| `hyperlocal_push` | H_info | trajectory_deviation_m | 325.52 | 95% CI [212.81, 394.90] | — | **inconclusive** | — |
| `global_distraction` | H_info | trajectory_deviation_m | 325.52 | 95% CI [212.81, 426.83] | — | **inconclusive** | 0.00 |
...
|---|---|---|---|
| `baseline` | 1433.00 | 1212.00 | 0.85 |
| `hyperlocal_push` | 1356.00 | 1073.00 | 0.79 |
| `global_distraction` | 1433.00 | 1212.00 | 0.85 |
| `phone_friction` | 1433.00 | 1212.00 | 0.85 |
...
- `global_distraction` vs `hyperlocal_push`: mirror delta = +0.00
